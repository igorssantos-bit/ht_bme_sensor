...
void HT_McuApi_enterGpioLowPower(void) {
	...
	GPIO_InitStructure.Pin = GPIO_PIN_All & (~GPIO_PIN_15) & (~LSM_INT2_XL_Pin) & (~LSM_INT_MG_Pin) & (~LED_Pin);
	HAL_GPIO_Init(GPIOA, &GPIO_InitStructure);

	GPIO_InitStructure.Pin = GPIO_PIN_All & (~GPIO_PIN_8) & (~GPIO_PIN_0) & (~GPIO_PIN_2) & (~GPIO_PIN_6) & (~GPIO_PIN_7);
